...
| TP | Titre | Thème | Durée estimée |
|----|-------|-------|---------------|
| [TP12](TP12 - Apprentissage Arduino/) | Prise en main de l'Arduino | Arduino Nano, LED, Bouton poussoir, PWM | 10h |
...
| [TP8](TP8 - Installation d un serveur téléphonique IP/) | Téléphonie IP, réseaux | Serveur Fusion PBX, Docker, câblage réseau, configuration de routeur | 10h |
...
| [TP15](TP15 - apprentissage CAD – carte Arduino meteo/) | KICAD, Réalisation d'un PCB | Crétion schéma, PCB et fichiers fabrication | 10h |
...
├── Fichiers/          # Fichiers de départ, templates, code source : Dossier optionnel
